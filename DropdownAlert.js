    ...
    if (isOpen) {
      ...
      return (
        ...
        >
          ...
          >
            <View style={[style,{borderRadius:10,marginHorizontal: 16,backgroundColor: 'transparent'}]}>
              <View style={{backgroundColor: this.props.successColor,paddingHorizontal:19,borderBottomLeftRadius:7,borderTopLeftRadius:7,justifyContent:'center',height:'100%',paddingVertical:10}}>
                <ImageView style={[StyleSheet.flatten(this.props.imageStyle),{width:15,height:19}]} source={source} />
              </View>
              <View style={{shadowColor: 'black', shadowOffset: { width: 0, height: 5 }, shadowRadius: 4, shadowOpacity: 0.2,
              backgroundColor:'white',paddingLeft:15,width:Dimensions.get('window').width-109,paddingVertical:10,borderBottomRightRadius:7,borderTopRightRadius:7}}>
                <Label style={[StyleSheet.flatten(this.props.titleStyle),{color:'#212123',fontFamily:'Poppins'}]} numberOfLines={this.props.titleNumOfLines} text={this.state.title} />
                <Label style={[StyleSheet.flatten(this.props.messageStyle),{color:'#212123',fontFamily:'Poppins'}]} numberOfLines={this.props.messageNumOfLines} text={this.state.message} />
              </View>
              {showCancel &&
                <TouchableOpacity
                  style={{
